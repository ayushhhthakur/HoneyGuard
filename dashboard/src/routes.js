...
const TrackToken = React.lazy(
  () => import("./views/theme/tracktoken/TrackToken.js"),
);
...
const Fingerprints = React.lazy(
  () => import("./views/fingerprints/Fingerprints.js"),
);
const FingerprintDetail = React.lazy(
  () => import("./views/fingerprints/FingerprintDetail.js"),
);
